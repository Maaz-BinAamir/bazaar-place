    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] font-sans selection:bg-[#FF6B6B] selection:text-white overflow-x-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8 font-medium text-sm">
          <Link
            href="#features"
            className="hover:text-[#FF6B6B] transition-colors hover:underline decoration-2 underline-offset-4"
          >
            How it works
          </Link>
          <Link href="/login">
            <Button variant="ghost" className="font-bold hover:bg-black/5">
              Log In
            </Button>
          </Link>
          <Link href="/bazaar">
      ...
      <main className="relative z-10">
          ...
          <div className="flex-1 space-y-8 relative">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight">
              ...
              <span className="relative inline-block text-[#FF6B6B]">
                second life
                <svg
                  className="absolute w-full h-3 -bottom-1 left-0 text-[#FF6B6B]/30"
                  viewBox="0 0 100 10"
            ...
            <p className="text-xl text-gray-600 max-w-lg leading-relaxed">
              BazaarPlace is where pre-loved items find new homes. List
              instantly, chat directly, and discover hidden gems in your
              neighborhood.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link href="/create-post">
                <Button
                  variant="outline"
                  className="h-14 px-8 rounded-xl bg-white text-black text-lg font-bold border-2 border-black shadow-[6px_6px_0px_0px_#E0E0E0] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_#E0E0E0] hover:bg-gray-50 transition-all w-full sm:w-auto"
                >
                  Sell an Item
                </Button>
              </Link>
            ...
            <div className="relative w-full max-w-md aspect-square perspective-1000">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 bg-black text-white p-6 rounded-2xl rounded-bl-none shadow-2xl z-30 animate-pulse-slow">
                ...
                <div className="mt-4 flex gap-2">
                  <div className="px-3 py-1 rounded-full bg-[#FF6B6B] text-xs font-bold">
                    Is this available?
                  </div>
                </div>
              </div>
        ...
        <div className="w-full bg-black py-4 overflow-hidden transform -skew-y-2 origin-left">
          <div className="flex gap-8 whitespace-nowrap animate-marquee">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div
                key={i}
                className="flex items-center gap-4 text-white/90 text-xl font-bold font-mono uppercase tracking-widest"
              >
        ...
        <section id="features" className="py-24 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-4xl md:text-5xl font-black">
              Simple. Safe. <span className="text-[#FF6B6B]">Social.</span>
            </h2>
            <p className="text-xl text-gray-500 max-w-2xl mx-auto">
              We&apos;ve stripped away the complexity. Buying and selling should
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group relative bg-white rounded-3xl p-8 border-2 border-black/5 hover:border-black/10 transition-all hover:-translate-y-2"
              >
                <div
                  className={`w-16 h-16 rounded-2xl ${feature.color} flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform`}
                >
                  {feature.icon}
                </div>
          ...
          <div className="max-w-5xl mx-auto bg-black rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <p className="text-xl text-white/70 max-w-2xl mx-auto">
                Join thousands of people finding new homes for their pre-loved
                items. It&apos;s free to list and easy to love.
              </p>
        ...
        <footer className="bg-white border-t border-gray-100 pt-16 pb-8 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2 md:col-span-1 space-y-4">
              ...
              <p className="text-sm text-gray-500">
                The modern marketplace for second-hand treasures. Built for
                community, designed for discovery.
              </p>
            </div>
            ...
            {[
              {
                title: "Platform",
                links: ["Browse", "Sell", "Search", "Categories"],
              },
              {
                title: "Company",
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-100 text-sm text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} BazaarPlace Inc. All rights
              reserved.
            </p>
