        ...
        <div className="relative z-10 max-w-lg p-12 space-y-12">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl font-black leading-tight">
              ...
              <span className="text-[#FF6B6B]">cash.</span>
            </h2>
            <p className="text-xl text-gray-400">
              Join the fastest growing marketplace for unique finds and
          ...
          <div className="grid gap-6">
            {[
              {
                title: "Free Listings",
                desc: "List as many items as you want, completely free.",
              },
              {
                title: "Secure Chat",
                desc: "Talk to buyers and sellers directly in the app.",
              },
              {
                title: "Local Finds",
                desc: "Discover hidden gems right in your neighborhood.",
              },
            ].map((item, i) => (
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-gray-500 font-medium">
              Start your journey with BazaarPlace today.
            </p>
          </div>
